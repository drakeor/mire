...
define(function (require, exports, module) {
  ...
  function Config (serverRef, variable, defaultValue)
  {
    ...
    this.db.findOne({ variable: this.variable }, (function (err, data) {
      if (Object.size(data) == 0) {
        // We should initialize this value.
        this.db.insert({variable: this.variable, value: this.value});
      } else {
  ...
  Config.prototype.set = function (value) {
    this.value = value;
    this.db.update({variable: this.variable}, {$set: {value: this.value}}, {});
  };
